...
const Loginbutton= () =>{
  ...
  <div className="sidebar">
    <div className="logo-details">
      <i className=''></i>
      <span className='logo_name1'>vehicle</span><span className="logo_name">Book</span>
    </div>
      <ul className="nav-links">
        ...
        <li>
            <NavLink className="dashlinks" to="/Addbrand">
            <i class="fa-sharp fa-solid fa-square-plus"></i>
            <span className="allLinks_name">Add Brand</span>
            </NavLink>
        </li>
        <li>
            <NavLink className="dashlinks" to="/addbikes">
            <i class="fa-sharp fa-solid fa-square-plus"></i>
            <span className="allLinks_name">Add vehicle</span>
            </NavLink>
        </li>
        ...
        <li>
            ...
            <span className="allLinks_name">Available Rent  car</span>
            </NavLink>
        </li>
        ...
        <li>
            ...
            <span className="allLinks_name">Rent  Income</span>
            </NavLink>
        </li>
        <li>
  ...
  <section className="home-section">
    ...
    <div className="home-content" style={{textAlign:"center"}}>
      ...
      <h3>Go To Add car Tab In Side Menu To Add Bikes In Database</h3><br/>
      <h3>Go To Rent car Tab In Side Menu To Generate Income Reports of Rented Bikes In Database</h3><br/>
      <h3>Go To Available car Tab In Side Menu To See All Available Users Regestered In Database</h3><br/>
      </div>
